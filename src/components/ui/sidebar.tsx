  ...
  (
    ...
    return (
      <aside
        ref={ref}
        className={cn(
            "group hidden md:flex flex-col h-screen bg-sidebar text-sidebar-foreground border-r transition-[width]",
